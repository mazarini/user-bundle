...
namespace Mazarini\UserBundle\Security;
...
class Authenticator extends AbstractFormLoginAuthenticator implements PasswordAuthenticatedInterface
{
    ...
    public function __construct(UserRepository $repository, UrlGeneratorInterface $urlGenerator, CsrfTokenManagerInterface $csrfTokenManager, UserPasswordEncoderInterface $passwordEncoder)
    {
    ...
    public function getUser($credentials, UserProviderInterface $userProvider): User
    {
        ...
        $user = $this->repository->findLogin($credentials['login']);
